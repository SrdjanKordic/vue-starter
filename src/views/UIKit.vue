	...
	<div>
		...
		<div class="row">
			<div class="col-12 mb-3">
				<div class="card">
					<div class="card-header">
						<div class="card-text fs-5">Filled buttons</div>
					</div>
					<div class="card-body">
						<div class="col-12">
							<a class="btn btn-primary me-1">Primary</a>
							<a class="btn btn-secondary me-1">Secondary</a>
							<a class="btn btn-success me-1">Success</a>
							<a class="btn btn-danger me-1">Danger</a>
							<a class="btn btn-warning me-1">Warning</a>
							<a class="btn btn-info me-1">Info</a>
							<a class="btn btn-dark me-1">Dark</a>
						</div>
					</div>
				</div>
			</div>
			<div class="col-12 mb-3">
				<div class="card">
					<div class="card-header">
						<div class="card-text fs-5">Outline buttons</div>
					</div>
					<div class="card-body">
						<div class="col-12">
							<a class="btn btn-outline-primary me-1">Primary</a>
							<a class="btn btn-outline-secondary me-1">Secondary</a>
							<a class="btn btn-outline-success me-1">Success</a>
							<a class="btn btn-outline-danger me-1">Danger</a>
							<a class="btn btn-outline-warning me-1">Warning</a>
							<a class="btn btn-outline-info me-1">Info</a>
							<a class="btn btn-outline-dark me-1">Dark</a>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="col-12 mb-3">
				<div class="card">
					<div class="card-header">
						<div class="card-text fs-5">Button sizes</div>
					</div>
					<div class="card-body">
						<div class="col-12">
							<a class="btn btn-primary btn-sm me-1">Primary SM</a>
							<a class="btn btn-secondary me-1">Secondary</a>
							<a class="btn btn-success btn-lg me-1">Success LG</a>
							<a class="btn btn-outline-danger btn-sm me-1">Danger SM</a>
							<a class="btn btn-outline-warning me-1">Warning</a>
							<a class="btn btn-outline-info btn-lg me-1">Info LG</a>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="card-body">
						<div class="row no-gutters align-items-center">
							...
							<div class="col-auto">
								...
								<font-awesome-icon :icon="['fas', 'box']" class="me-1 fa-2x text-primary" />
							</div>
						</div>
					</div>
				</div>
...
export default {
	...
	data() {
		return {
			...
			statsChart: {
				labels: ['mon', 'thu', 'wen', 'thr', 'fry', 'sat', 'sun'],
				datasets: [
					{
						label: 'APP Open',
						data: [5, 7, 1, 9, 2, 4, 1],
						...
						borderWidth: 1,
						borderColor: '#2a9836',
						backgroundColor: 'rgba(42, 152, 54, 0.05)',
					},
					{
						label: 'Widget Open',
						data: [1, 2, 3, 1, 2, 3, 5],
